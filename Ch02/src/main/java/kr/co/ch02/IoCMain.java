...
public class IoCMain {
	...
	public static void main(String[] args) {
		...
		//IoC를 활용하지 않은 객체 생성
		/*
		 * TV t1 = new LgTV(); TV t2 = new SamsungTV();
		 * 
		 * t1.powerOn(); t1.chUp(); t1.soundUp();
		 * 
		 * t2.powerOn(); t2.chUp(); t2.soundUp();
		 */
		
		//IoC를 활용한 객체 생성
		ApplicationContext context = new GenericXmlApplicationContext("application.xml");
		TV ltv = (TV) context.getBean("ltv");
		TV stv = (TV) context.getBean("stv");
